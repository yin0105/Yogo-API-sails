...
describe('helpers.populate.classes.class-accepts-waiting-list-signups', async function () {
  ...
  it('should return an empty array if input is empty', async () => {
    ...
    const result = await sails.helpers.populate.classes.classAcceptsWaitingListSignups([])
  ...
  it('should return input array unchanged if input is already populated', async () => {
    ...
    const classes = [
      {
        class_accepts_waiting_list_signups: true,
      },
      {
        class_accepts_waiting_list_signups: false,
      },
    ]

    await sails.helpers.populate.classes.classAcceptsWaitingListSignups(classes)
