...
module.exports.models = {
    ...
    attributes: {
        ...
        id: {type: 'number', autoIncrement: true}, // This setup seems to be the one working if you want to get ID back from .create()
    ...
    dataEncryptionKeys: {
        default: 'b6lmkZC7Iktn+5nIgO5s/iURqDduDy+Wd6RwDYleGpE='
    },
