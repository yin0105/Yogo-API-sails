...
module.exports.routes = {
  ...
  'PATCH /cp/v1/reservations/:id': 'IntegrationsClasspassComController.cancel-reservation',
  ...
  'POST /reports/class': 'ReportsController.classes',
  'GET /reports/class': 'ReportsController.classes',
