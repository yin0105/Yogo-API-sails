...
describe('get-valid-memberships-for-livestream--membership-pause', async function () {
  ...
  it('should return memberships that do not have a membership pause overlapping the class', async () => {
    ...
    const validMembershipsForClass0 = await sails.helpers.classes.getValidMembershipsForLivestream.with({
  ...
  it('should not return memberships that have a membership pause overlapping the class', async () => {
    ...
    const validMembershipsForClass1 = await sails.helpers.classes.getValidMembershipsForLivestream.with({
      user: fixtures.userAlice,
      classItem: classes[1],
    });
  ...
  it('should account for membership pauses without end date', async () => {
    ...
    const validMembershipsForClass2 = await sails.helpers.classes.getValidMembershipsForLivestream.with({
      user: fixtures.userAlice,
      classItem: classes[2],
    });
