module.exports = {
  ...
  friendlyName: 'Populate class waiting list signups',

  description: 'Populates an array of class waiting list signups with the specified relations',

  inputs: {
    classWaitingListSignups: {
      type: 'ref',
      description: 'An array of class waiting list signups or a single class waiting list signup.',
      required: true,
    },
  ...
  async fn(inputs, exits) {
    ...
    const eagerPopulateConfig = sails.helpers.populate.relationFieldListToEagerLoadConfigObject(populateFields)
