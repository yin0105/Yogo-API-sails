...
module.exports = {
  friendlyName: 'Populate Class.class_starts_today_or_later',
  ...
  fn: async function (inputs, exits) {
    ...
    // Already populated??
    if (typeof inputs.classes[0].class_starts_today_or_later !== 'undefined') {
    ...
    _.each(inputs.classes, cls => {
      ...
      cls.class_starts_today_or_later = classDate.isSameOrAfter(now, 'day')
